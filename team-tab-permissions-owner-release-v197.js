...
function clearDeny(e){DENY.forEach(function(c){try{e.classList.remove(c)}catch(x){}});try{if(e.style&&e.style.display==='none')e.style.removeProperty('display')}catch(x){}}
