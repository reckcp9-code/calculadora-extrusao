(function(){
  ...
  async function sacolaData(){
    ...
    // Se foi informado um peso desejado na nova linha da aba Sacolas,
    // ele tem prioridade e a quantidade correspondente é usada no Custo.
  ...
  async function calc(){
    ...
    try{
      ...
      set('cuLucro','+'+fmt(lucroPct,2)+'% = '+(custoRolo?rs(Number(r.lucroTotal)||0):'—'));
