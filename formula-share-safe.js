(function(){
  ...
  async function shareWhatsApp(){
    ...
    const msg='*DF EXTRUSOR PRO – FORMULAÇÃO*\n\n'+
      ...
      resinRowsText(f)+'\n\n'+
      '*TOTAL: '+fm(srv.totalPct||0,2)+'%*\n'+
      '*FATOR KG: '+money(srv.custoKgFinal||0)+'/kg*\n\n'+
      '_Custo referente apenas à formulação das resinas. Não inclui custo fabril, mão de obra, energia, extrusão ou demais custos de fabricação._';
  ...
  function mount(){
    ...
    wrap.innerHTML='<div class="savedBtns" style="grid-template-columns:repeat(2,1fr);margin-top:8px"><button id="foWhatsResina" class="miniBtn" type="button">WHATSAPP</button><button id="foPdfResina" class="miniBtn" type="button">RESINAS PDF</button></div><div class="formNote" style="margin-top:6px">Compartilha somente a formulação fechada em 100% e o Fator KG das resinas. Sem custo fabril.</div>';
