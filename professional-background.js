(function(){
  ...
  function addStyle(){
    ...
    st.textContent=`
      ...
      body{
        ...
        background-image:
          radial-gradient(circle at 78% 10%,rgba(255,152,0,.12),transparent 30%),
          radial-gradient(circle at 15% 38%,rgba(255,212,71,.05),transparent 28%),
          linear-gradient(180deg,#050608 0%,#090b0e 48%,#050608 100%)!important;
      ...
      .brand{
        position:relative!important;overflow:hidden!important;min-height:400px!important;
        display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;
        background:
          linear-gradient(90deg,rgba(3,4,5,.80),rgba(3,4,5,.46) 44%,rgba(3,4,5,.32) 68%,rgba(3,4,5,.70)),
          url('./df-dashboard-pro.webp?v=1') center 28%/cover no-repeat!important;
        border:1px solid rgba(255,152,0,.85)!important;border-radius:22px!important;
        padding:34px 24px 30px!important;
        box-shadow:0 22px 65px rgba(0,0,0,.58),0 0 28px rgba(255,152,0,.10)!important;
      }
      .brand:after{content:'';position:absolute;inset:auto 0 0;height:3px;background:linear-gradient(90deg,transparent,var(--dfOrange),var(--dfYellow),transparent);opacity:.75}
      ...
      #heroSub{font-size:13px!important;color:#d8dde2!important;letter-spacing:.14em!important;font-weight:800!important;text-shadow:0 2px 10px #000!important}

      #appContent>.tabs{
        position:relative!important;top:auto!important;display:grid!important;grid-template-columns:repeat(4,1fr)!important;
        gap:14px!important;margin:16px 0!important;padding:0!important;background:transparent!important;border:0!important;box-shadow:none!important;
      }
      ...
      .card h1,.card h2,.card h3,.card h4{color:var(--dfWhite)!important}
      .card .tag,.card strong{color:var(--dfYellow)}
      ...
      button,.btn{border-color:#4a5057}
      button.primary,.btn.primary,.btn.on{background:linear-gradient(180deg,#ffad19,#f28a00)!important;color:#0b0b0b!important;border-color:#ffc34f!important;font-weight:900!important}
      ...
      @media(max-width:650px){
        ...
        #appContent.w{padding:12px 10px 36px!important}
        .brand{min-height:330px!important;padding:22px 14px!important;border-radius:18px!important;background-position:center center!important}
        .brand .logo{width:min(245px,72vw)!important;max-height:170px!important}
        #heroTitle{font-size:31px!important}
        #heroSub{font-size:10px!important;letter-spacing:.07em!important}
        #appContent>.tabs{grid-template-columns:repeat(2,1fr)!important;gap:9px!important}
        #appContent>.tabs .tab{min-height:72px!important;font-size:11px!important}
        #dfBetaApp{padding:14px!important}
      }
    `;
  ...
  function ensureSide(){
    if($('dfProSide'))return;
    const side=document.createElement('aside');side.id='dfProSide';side.innerHTML=`
