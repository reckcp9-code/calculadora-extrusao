(function(){
  ...
  function openOP(f){
    ...
    const html='<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><title>OP '+esc(nome)+'</title><style>'+ 
      '@page{size:297mm 210mm;margin:0}*{box-sizing:border-box}html,body{margin:0;padding:0;background:#e5e7eb;font-family:Arial,Helvetica,sans-serif;color:#111}.toolbar{position:sticky;top:0;z-index:20;display:flex;gap:8px;align-items:center;padding:9px 12px;background:#111827;color:#fff}.toolbar button{border:0;border-radius:7px;padding:9px 13px;font-weight:800;cursor:pointer}.back{background:#e5e7eb;color:#111827}.print{background:#111;color:#fff;border:1px solid #fff!important}.sheet{width:297mm;max-width:calc(100vw - 16px);margin:10px auto;background:#fff;padding:5mm;box-shadow:0 4px 20px #0002}.op{width:100%;border-collapse:collapse;table-layout:fixed;font-size:9px}.op td,.op th{border:1px solid #333;padding:2px 3px;vertical-align:middle;height:16px}.center{text-align:center}.b{font-weight:700}.logo{font-size:15px;font-weight:900;letter-spacing:.3px}.title{background:#d1d5db;color:#111;text-align:center;font-weight:900}.shade{background:#f3f4f6}.shade2{background:#e5e7eb}.top td{height:20px}.big{font-size:13px}.xbig{font-size:16px}.mat th{background:#d1d5db;color:#111}.prod th{background:#e5e7eb;font-size:8px}.codes td{font-size:8px;background:#f8fafc}.sectionGap{height:3px;border:0}.obs{height:25px}.miniTitle{font-size:8px;color:#333;font-weight:700;text-transform:uppercase}.value{font-size:12px;font-weight:900}.stamp{float:right;border:1px solid #333;border-radius:5px;padding:3px 8px;font-weight:900;background:#fff}@media print{html,body{background:#fff!important;width:297mm!important;height:210mm!important;min-width:297mm!important;min-height:210mm!important;margin:0!important;padding:0!important}.toolbar{display:none!important}.sheet{width:297mm!important;height:210mm!important;max-width:none!important;margin:0!important;padding:5mm!important;box-shadow:none!important;display:flex!important;flex-direction:column!important;justify-content:space-between!important;overflow:hidden!important;page-break-after:avoid!important}.op{flex:0 0 auto}.top td{height:8mm!important}.sheet>.op:not(.top):not(.mat):not(.prod):not(.codes) td,.sheet>.op:not(.top):not(.mat):not(.prod):not(.codes) th{height:7mm!important}.mat td,.mat th{height:6mm!important}.prod td,.prod th{height:7mm!important}.codes td,.codes th{height:5.5mm!important}.op td,.op th{padding:1.3mm 1.7mm}.obs{height:11mm!important}.sectionGap{height:1mm!important;flex:0 0 1mm}.logo{font-size:18px}.xbig{font-size:18px}.big{font-size:15px}.value{font-size:14px}.miniTitle{font-size:9px}}'+
      '</style></head><body><div class="toolbar"><button class="back" onclick="try{if(window.opener&&!window.opener.closed)window.opener.focus()}catch(e){};window.close()">← VOLTAR PARA FORMULAÇÃO</button><button class="print" onclick="window.print()">IMPRIMIR / SALVAR PDF</button><span>OP em A4 DEITADO</span></div><div class="sheet">'+
