(function(){
  ...
  function openOP(f){
    ...
    let prodRows='';
    for(let i=0;i<10;i++)prodRows+='<tr><td>&nbsp;</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>';

    const style='@page{size:A4 landscape;margin:0}'+
      '*{box-sizing:border-box}html,body{margin:0;padding:0;background:#dfe3e8;font-family:Arial,Helvetica,sans-serif;color:#111}'+
      'body{min-width:100%;overflow-x:auto}.toolbar{position:sticky;top:0;z-index:20;display:flex;gap:8px;align-items:center;padding:9px 12px;background:#111827;color:#fff;box-shadow:0 2px 10px #0003}.toolbar button{border:0;border-radius:7px;padding:9px 13px;font-weight:900;cursor:pointer}.back{background:#e5e7eb;color:#111827}.print{background:#111;color:#fff;border:1px solid #fff!important}.hint{font-size:13px;opacity:.9}'+
      '.sheet{width:297mm;height:210mm;margin:10px auto;background:#fff;padding:4mm;box-shadow:0 6px 26px #0002;overflow:hidden;display:flex;flex-direction:column;justify-content:space-between}'+
      '.op{width:100%;border-collapse:collapse;table-layout:fixed;font-size:10px;line-height:1.05}.op td,.op th{border:1px solid #333;padding:2.2px 3px;vertical-align:middle}.center{text-align:center}.b{font-weight:800}.logo{font-size:18px;font-weight:900;letter-spacing:.3px}.title{background:#d1d5db;color:#111;text-align:center;font-weight:900}.shade{background:#f3f4f6}.shade2{background:#e5e7eb}.top td{height:22px}.big{font-size:14px}.xbig{font-size:18px}.mat th{background:#d1d5db;color:#111}.mat td{height:22px}.prod th{background:#e5e7eb;font-size:9px}.prod td{height:18px}.codes td{font-size:9px;background:#f8fafc;height:18px}.sectionGap{height:3px;flex:0 0 3px}.obs{height:30px}.miniTitle{font-size:8.5px;color:#333;font-weight:800;text-transform:uppercase}.value{font-size:13px;font-weight:900}.stamp{float:right;border:1px solid #333;border-radius:6px;padding:4px 10px;font-weight:900;background:#fff}'+
      '@media(max-width:900px){body{background:#dfe3e8}.sheet{width:297mm;height:210mm;transform-origin:top left;transform:scale(calc((100vw - 14px) / 1122));margin-left:7px;margin-right:0;margin-bottom:calc(210mm * ((100vw - 14px) / 1122) * -0.02)}}'+
      '@media print{html,body{background:#fff!important;width:297mm!important;height:210mm!important;min-width:297mm!important;min-height:210mm!important;margin:0!important;padding:0!important;overflow:hidden!important}.toolbar{display:none!important}.sheet{position:fixed!important;left:0!important;top:0!important;width:297mm!important;height:210mm!important;max-width:none!important;margin:0!important;padding:4mm!important;box-shadow:none!important;transform:none!important;display:flex!important;flex-direction:column!important;justify-content:space-between!important;overflow:hidden!important;page-break-after:avoid!important}.op{font-size:10.5px!important;line-height:1.05!important}.op td,.op th{padding:1.2mm 1.4mm!important}.top td{height:8mm!important}.sheet>.op:not(.top):not(.mat):not(.prod):not(.codes) td,.sheet>.op:not(.top):not(.mat):not(.prod):not(.codes) th{height:7mm!important}.mat td,.mat th{height:6mm!important}.prod td,.prod th{height:6.2mm!important}.codes td,.codes th{height:5.5mm!important}.obs{height:11mm!important}.sectionGap{height:1mm!important;flex:0 0 1mm}.logo{font-size:18px!important}.xbig{font-size:18px!important}.big{font-size:15px!important}.value{font-size:14px!important}.miniTitle{font-size:9px!important}}';

    const html='<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>OP '+esc(nome)+'</title><style>'+style+'</style></head><body><div class="toolbar"><button class="back" onclick="try{if(window.opener&&!window.opener.closed)window.opener.focus()}catch(e){};window.close()">← VOLTAR PARA FORMULAÇÃO</button><button class="print" onclick="window.print()">IMPRIMIR / SALVAR PDF</button><span class="hint">OP em A4 deitado — preenchendo a folha toda</span></div><div class="sheet">'+
