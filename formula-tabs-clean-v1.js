(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=[
      ...
      '@media(max-width:560px){#pgFo > .dfAutoTopics{display:flex!important;gap:7px!important;overflow-x:auto!important;overflow-y:hidden!important;-webkit-overflow-scrolling:touch!important;scrollbar-width:none!important;grid-template-columns:none!important;padding-bottom:2px!important}#pgFo > .dfAutoTopics::-webkit-scrollbar{display:none!important}#pgFo > .dfAutoTopics .dfAutoTopic{flex:0 0 auto!important;width:auto!important;min-width:145px!important;white-space:nowrap!important;font-size:10px!important;min-height:44px!important;padding-left:12px!important;padding-right:12px!important}#pgFo > .dfAutoTopics [data-df-nav-menu="1"]{min-width:110px!important;order:1!important}#pgFo > .dfAutoTopics [data-df-formula-top="1"]{order:2!important}#pgFo > .dfAutoTopics [data-df-nav-whats="1"]{order:3!important}#pgFo > .dfAutoTopics [data-df-nav-backup="1"]{order:4!important}#pgFo > .dfAutoTopics [data-df-nav-ops="1"]{display:none!important}}'
    ].join('');
