(function(){
  'use strict';
  if(window.DFProductionNowTestV1)return;
  window.DFProductionNowTestV1=true;

  const KEY='df_production_now_test_v1';
